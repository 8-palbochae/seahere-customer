    ...
    return (
        <>
            ...
            <div className='flex flex-col items-center p-2'>
                ...
                <div className='font-bold w-full text-left text-lg ml-2 mt-4 mb-2'>출고 요청을 확인 해주세요</div>
                <div className='w-full items-center p-4 border rounded-md shadow-md'>
                    <div className='flex justify-between border-b my-2 pb-4'>
                        ...
                        <div><span className='text-blue-600 font-semibold'>{totalQuantity}</span> Kg</div>
                    </div>
                    <div className='flex justify-between my-2 pt-2'>
                        <div className='font-semibold'>총 출고 금액</div>
                        <div><span className='text-blue-600 font-semibold'>{totalShipmentAmount.toLocaleString()}</span> 원</div>
                    </div>
                </div>
            </div>
        </>
